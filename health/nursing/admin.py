...
class TaskAdmin(admin.ModelAdmin):
    list_display = ('bed', 'programed_time', 'done_time', 'task', 'repeat_id', 'active', 'state', 'programed_by', 'action_done_by')
    ordering = ('-programed_time',)
    search_fields = ('bed', 'programed_time', 'done_time', 'task', 'repeat_id', 'active', 'state', 'programed_by', 'action_done_by')
    list_filter = ('bed', 'programed_time', 'done_time', 'task', 'repeat_id', 'active', 'state', 'programed_by', 'action_done_by',)
